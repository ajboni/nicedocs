import { _ as _asyncToGenerator, a as _regeneratorRuntime, b as _inherits, e as _classCallCheck, i as init, s as safe_not_equal, f as _assertThisInitialized, g as dispatch_dev, A as _createClass, S as SvelteComponentDev, c as config, d as docs, v as validate_slots, h as _getPrototypeOf, j as _possibleConstructorReturn, l as element, k as space, q as query_selector_all, o as claim_element, p as children, m as detach_dev, n as claim_space, B as attr_dev, u as add_location, x as append_dev, w as insert_dev, y as _slicedToArray, z as noop } from './client.af586962.js';
...
function create_fragment(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      add_location(link, file, 65, 2, 1574);
      ...
      add_location(script, file, 68, 2, 1682);
      attr_dev(div, "class", "content svelte-h98meu");
      add_location(div, file, 75, 0, 1814);
    },
...
function _preload() {
  _preload = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(_ref3) {
    var params, query, searchParams, res, data;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 4;
            return this.fetch("".concat(params.slug, ".json?").concat(searchParams));
